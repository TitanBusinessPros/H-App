...
- Current product order: Website Maker, Catering Generator, Coupon Generator, QR Code Generator, Horror Film Trivia Website Maker, Flyer Builder.
...
- Local source HTML files are in the parent folder: `H-WM.html`, `HCG.html`, `HCB.html`, `Halloween QR Code Generator.html`, `HTWM.html`, and `HFB.html`. The top-level parent `index.html` is a local working copy of the currently edited standalone tool. This repository's `index.html` remains the product hub.
